...
python visualize_contour --load_filename=MLE_1.pkl --save_filename=MLE_1.pdf --dataset_i=1
python visualize_contour --load_filename=MLE_2.pkl --save_filename=MLE_2.pdf --dataset_i=2
...
python visualize_contour --load_filename=L2_1.pkl --save_filename=L2_1.pdf --dataset_i=1
python visualize_contour --load_filename=L2_2.pkl --save_filename=L2_2.pdf --dataset_i=2
...
python visualize_contour --load_filename=dropout_1.pkl --save_filename=dropout_1.pdf --dataset_i=1
python visualize_contour --load_filename=dropout_2.pkl --save_filename=dropout_2.pdf --dataset_i=2
...
python visualize_contour --load_filename=RP_1.pkl --save_filename=RP_1.pdf --dataset_i=1
python visualize_contour --load_filename=RP_2.pkl --save_filename=RP_2.pdf --dataset_i=2
...
python visualize_contour --load_filename=AT_1.pkl --save_filename=AT_1.pdf --dataset_i=1
python visualize_contour --load_filename=AT_2.pkl --save_filename=AT_2.pdf --dataset_i=2
...
python visualize_contour --load_filename=VAT_1.pkl --save_filename=VAT_1.pdf --dataset_i=1
python visualize_contour --load_filename=VAT_2.pkl --save_filename=VAT_2.pdf --dataset_i=2
